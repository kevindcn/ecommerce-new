...
import LoginModal from '@/components/LoginModal'       // ← tambah
...
export default function CartPage() {
  ...
  const { isLoggedIn } = useAuth()                     // ← tambah
  const [showLoginModal, setShowLoginModal] = useState(false)  // ← tambah
  ...
  // ✅ Proteksi checkout — cek login dulu
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-6 shadow-sm sticky top-24 space-y-5">
                ...
                {/* ✅ Tombol checkout — sekarang cek login dulu */}
                <Button
      ...
      {/* ✅ Login Modal — muncul saat checkout tanpa login */}
      <LoginModal
        isOpen={showLoginModal}
        onClose={() => setShowLoginModal(false)}
        message="Masuk dulu untuk melanjutkan checkout ya! 🛍️"
